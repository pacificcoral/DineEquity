...
class PasteCleanup {
    ...
    plainFormatting(value, args) {
        ...
        let firstElm = resultElement.firstElementChild;
        if (!isNullOrUndefined(resultElement.firstElementChild)) {
            let spanElm = this.parent.createElement('span');
            spanElm.innerHTML = resultElement.firstElementChild.textContent;
            resultElement.insertBefore(spanElm, resultElement.firstElementChild);
            detach(firstElm);
        }
        this.saveSelection.restore();
